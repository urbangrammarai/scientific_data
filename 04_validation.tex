...
All datasets, spatial signatures, and those selected as validation contain
...
an interpolation of one set of polygon-based data to another (input to ETCs) or converting
...
although there are some indicators that would be classified as a function within the
...
continuity and density resulting in 6 classes of the urban fabric. The classification does
...
the uniqueness of the presented typology.